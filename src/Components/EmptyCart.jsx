...
const EmptyCart = () => {
    return (
        <div class="empty-cart">
            ...
            <svg viewBox="656 573 264 182" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
            ...
            <p>Gusen fertelman jerting Klamm geragen, hund Freserling hussental men stark verbasen in Untermerk.</p>
        </div>
    );
};
